  ...
  try {
    ...
    const content = `
      ...
      <p style="font-size:12px;color:#94A3B8;text-align:center;margin:0;">
        Ada pertanyaan? Email ke <a href="mailto:support@aturpintar.id" style="color:#FF6A00;text-decoration:none;">support@aturpintar.id</a>
      </p>
    `;
    ...
    return Response.json({ success: true, message: `Beta invite email sent to ${email}` });
  } catch (error) {
