            ...
            <div className="flex items-center justify-between py-2 mb-1">
              <div className="flex gap-2">
                <button onClick={() => cameraRef.current?.click()} disabled={scanning}
                  className="flex items-center gap-1 px-2.5 py-1 rounded-lg bg-[#F97316]/10 text-[10px] font-semibold text-[#F97316]">
            ...
            {receiptData && (
              <div className="mb-4 bg-[#FFF5EB] border border-[#F97316]/20 rounded-2xl p-4">
                ...
                <div className="flex justify-between mb-2">
                  ...
                  <p className="text-sm font-bold text-[#F97316]">Rp{receiptData.total_amount?.toLocaleString("id-ID")}</p>
                </div>
