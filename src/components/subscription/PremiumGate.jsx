    ...
    return (
      <div className="fixed inset-0 bg-black/60 z-[100] flex items-end sm:items-center justify-center p-4">
        <div className="bg-white rounded-2xl w-full max-w-sm shadow-xl p-8 text-center">
          ...
          <button onClick={onClose} className="w-full py-3 bg-[#F97316] text-white rounded-xl font-semibold text-sm hover:bg-[#e05e00] transition-colors">OK</button>
        </div>
      </div>
    );
  }
        ...
        <div className="p-5">
          ...
          <div className="grid grid-cols-2 gap-2 mb-4">
            <button
              ...
              className={`p-3 rounded-xl border-2 text-left transition-all ${selectedPlan === 'premium_monthly' ? 'border-[#F97316] bg-[#F97316]/5' : 'border-[#E2E8F0]'}`}
            >
          ...
          <button
            onClick={handleBuy}
            disabled={loading}
            className="w-full py-3 bg-[#F97316] text-white rounded-xl font-bold text-sm flex items-center justify-center gap-2 hover:bg-[#e05e00] transition-colors disabled:opacity-60"
          >
            {loading
