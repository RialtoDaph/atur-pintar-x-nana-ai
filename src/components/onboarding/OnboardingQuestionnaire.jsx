        ...
        <div className="p-6">
          ...
          {currentStep.id === "welcome" && (
            <div className="text-center">
              ...
              <h2 className="text-xl font-bold text-[#1A1A1A] mb-2">Selamat Datang di Atur.in!</h2>
          ...
          {currentStep.id === "income" && (
            <div>
              ...
              <NavButtons onPrev={prev} onNext={next} onSkip={() => { setMonthlyIncome(""); setMonthlyExpense(""); next(); }} />
            </div>
          )}
          ...
          {currentStep.id === "risk" && (
            <div>
              ...
              <NavButtons onPrev={prev} onNext={next} onSkip={next} />
            </div>
          )}
