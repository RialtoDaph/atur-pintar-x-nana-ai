...
function NanaAvatar({ size = 80, animate = false }) {
  return (
    <motion.div
      ...
      style={{ width: size, height: size }} className="bg-[#F2F4F7] mx-auto rounded-full border-2 border-[#FF6A00] overflow-hidden">
...
function ScreenQuizIntro({ onNext }) {
  return (
    <div className="mt-16 mr-5 ml-5 px-6 py-8 text-center flex flex-col items-center">
