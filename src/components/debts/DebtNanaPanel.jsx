    ...
    <div className="bg-white rounded-2xl shadow-sm overflow-hidden">
      ...
      >
        ...
        <div className="flex-1 min-w-0">
          <p className="text-sm font-semibold text-[#1A1A1A] truncate">Strategi Pelunasan Utang</p>
          <p className="text-xs text-[#8FA4C8] truncate">{activeDebts.length} utang aktif · {formatCurrency(totalRemaining)}</p>
        </div>
        {loading
