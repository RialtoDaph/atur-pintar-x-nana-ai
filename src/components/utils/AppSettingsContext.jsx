...
const TRANSLATIONS = {
  id: {
    ...
    goal_name_placeholder: 'mis. Liburan Impian',
    target_amount: 'Target',
    current_saved: 'Sudah Ditabung',
    deadline_optional: 'Tenggat Waktu (opsional)',
    description_optional: 'Deskripsi (opsional)',
    goal_desc_placeholder: 'Mengapa Anda menabung untuk ini?',
    ...
    withdraw: 'Tarik',
    available: 'Tersedia',
    note_deposit_placeholder: 'mis. Tabungan bulanan',
    note_withdraw_placeholder: 'mis. Pengeluaran darurat',
  ...
  en: {
    ...
    goal_name: 'Goal Name',
    goal_name_placeholder: 'e.g. Dream Vacation',
    target_amount: 'Target Amount',
    current_saved: 'Already Saved',
    deadline_optional: 'Deadline (optional)',
    description_optional: 'Description (optional)',
    goal_desc_placeholder: 'Why are you saving for this?',
    edit_goal: 'Edit Goal',
    ...
    withdraw: 'Withdraw',
    available: 'Available',
    note_deposit_placeholder: 'e.g. Monthly savings',
    note_withdraw_placeholder: 'e.g. Emergency expense',
