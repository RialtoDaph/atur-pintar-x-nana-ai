    ...
    <div className="min-h-screen bg-[#0A0A0A] text-white font-sans overflow-x-hidden">
      ...
      <style>{`
        ...
        * { font-family: 'Inter', sans-serif; }
        ...
        .page-bg { background-image: radial-gradient(rgba(255,255,255,0.12) 1px, transparent 1px); background-size: 28px 28px; }
      ...
      <section className="pt-16 pr-5 pb-20 pl-5 sm:px-12 lg:px-20 relative z-10">
        ...
        <div className="max-w-5xl text-center sm:text-left">
          ...
          <h1 className="text-4xl sm:text-6xl lg:text-7xl font-black leading-[1.1] mb-5 max-w-3xl">
            Uang kamu hilang<br />
          ...
          <div className="mt-8 flex items-center justify-center sm:justify-start gap-3">
            ...
            <p className="text-[hsl(var(--muted-foreground))] text-sm">Sudah dipakai 2.400+ pengguna aktif di Indonesia</p>
          </div>
        </div>
      </section>
      ...
      <section className="px-5 sm:px-12 lg:px-20 pb-20 relative z-10">
        <div className="max-w-2xl mx-auto sm:mx-0">
          <div className="card-d rounded-3xl p-8 glow text-center sm:text-left">
            ...
            <p className="text-white/60 text-sm leading-relaxed italic">"Dirancang deng
